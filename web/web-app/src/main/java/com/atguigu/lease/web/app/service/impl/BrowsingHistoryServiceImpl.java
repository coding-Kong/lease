...
public class BrowsingHistoryServiceImpl extends ServiceImpl<BrowsingHistoryMapper, BrowsingHistory>
    ...
    public void saveHistory(Long userId, Long id) {
        ...
        if(browsingHistory!=null){
            ...
            BrowsingHistory newBrowHistory = new BrowsingHistory();
            newBrowHistory.setBrowseTime(new Date());
            newBrowHistory.setUserId(userId);
            newBrowHistory.setRoomId(id);
            browsingHistoryMapper.insert(newBrowHistory);
        }
    }
}