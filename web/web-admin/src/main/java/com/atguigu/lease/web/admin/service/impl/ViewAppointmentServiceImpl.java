...
public class ViewAppointmentServiceImpl extends ServiceImpl<ViewAppointmentMapper, ViewAppointment>
    ...
    @Override
    public IPage<AppointmentVo> pageAppointment(Page<ViewAppointment> page, AppointmentQueryVo queryVo) {
        return viewAppointmentMapper.selectViewAppointmentMapper(page,queryVo);
    }
}
